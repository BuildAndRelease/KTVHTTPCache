Pod::Spec.new do |s|
  s.name                = "JKTVHTTPCache"
  s.version             = "2.0.1.4"
  s.summary             = "A powerful media cache framework."
  s.homepage            = "https://github.com/BuildAndRelease/KTVHTTPCache"
  s.license             = { :type => "MIT", :file => "LICENSE" }
  s.author              = { "Single" => "514961926@qq.com" }
  s.social_media_url    = "https://weibo.com/3118550737"
  s.platform            = :ios, "8.0"
  s.source              = { :git => "https://github.com/BuildAndRelease/KTVHTTPCache.git", :tag => "#{s.version}" }
